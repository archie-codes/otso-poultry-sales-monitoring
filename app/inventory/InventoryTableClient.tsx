...
export default function InventoryTableClient({
  ...
  return (
    <div className="flex flex-col space-y-8 relative">
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button
                      variant="ghost"
                      size="icon"
                      className="h-10 w-10 sm:h-11 sm:w-11 rounded-xl hover:bg-secondary shrink-0 border border-border/50 bg-white dark:bg-slate-950 shadow-sm"
                    >
      ...
      >
        <DialogContent className="max-w-2xl rounded-[2rem] p-0 overflow-hidden border-border/50">
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  defaultValue={
                    editingDelivery
                      ? format(
                          new Date(editingDelivery.deliveryDate),
                          "yyyy-MM-dd",
                        )
                      : ""
                  }
                  className="h-11 rounded-xl font-bold bg-slate-50 dark:bg-slate-900 border-border/50 uppercase text-muted-foreground"
                />
              </div>
              <div className="space-y-1.5">
                <label className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">
