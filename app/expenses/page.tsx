      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-card border border-border/50 p-6 rounded-3xl shadow-sm flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0 overflow-hidden">
            ...
            <p
              className="text-2xl lg:text-3xl md:text-2xl font-black tracking-tight text-foreground truncate mt-0.5"
        ...
        <div className="bg-card border border-border/50 p-6 rounded-3xl shadow-sm flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0 overflow-hidden">
            ...
            <p
              className="text-xl lg:text-2xl font-black text-foreground capitalize truncate mt-0.5"
              title={topCategory}
            >
              {topCategory}
            </p>
