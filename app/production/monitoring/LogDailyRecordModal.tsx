...
export default function LogDailyRecordModal({
  ...
  // Read the new stock data containing qty AND price
  ...
  // ---> NEW: Get exact price for Live Calculation
      ...
      {isOpen &&
        ...
        createPortal(
          <div className="fixed inset-0 z-100 flex items-center justify-center bg-background/80 backdrop-blur-sm p-4 animate-in fade-in">
            <div className="fixed z-101 w-full max-w-4xl border bg-background p-6 md:p-8 shadow-2xl rounded-[2.5rem] max-h-[90vh] overflow-y-auto custom-scrollbar">
                    ...
                    >
                      <PopoverTrigger asChild>
                        <Button
                          ...
                          className="w-full h-11 justify-between rounded-xl font-bold bg-slate-50 dark:bg-slate-900 disabled:opacity-50"
                        >
                          <span className="truncate">
                            {selectedLoad
                  ...
                  <div className="md:col-span-8 bg-amber-50/30 dark:bg-amber-950/10 border border-amber-100 dark:border-amber-900/30 rounded-[2rem] p-6 space-y-5">
                    <div className="flex justify-between items-center pb-2 border-b border-amber-200/30">
                      ...
                      >
                        ...
                        <PopoverContent className="p-0 z-200 w-52" align="end">
                          <Command>
                            <CommandList>
                    ...
                    >
                      <div className="flex flex-col">
                        ...
                        {/* ONLY SHOWS UP IF THERE IS A VALID PRICE! */}
